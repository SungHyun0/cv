<?php
$content=\file_get_contents('data/contacts.yaml');
...
if (isset ($_POST['g-recaptcha-response']) &&! empty ($_POST ['g-recaptcha-response'])) {
    ...
    if( !empty($_POST)){
        ...
        try {
            ...
            $mail->Username = 'thomas.maison@sts-sio-caen.info';             // SMTP username
            ...
            $mail->addAddress('thomas.maison@sts-sio-caen.info'); // Add a recipient address
